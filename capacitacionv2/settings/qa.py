...
DATABASES = {
    # default BASE DE DATOS PRINCIPAL DE CAPACITACIÓN
    'default': {
    ...
    # default Se usa para obtener las metas de capacitacion
    'consecucion': {
        'ENGINE': 'sql_server.pyodbc',
    ...
    # default Se usa para obtener algunos datos de ubigeos, zonas, etc.
    'segmentacion': {
        'ENGINE': 'sql_server.pyodbc',
        ...
        'HOST': '172.18.1.41',
        'OPTIONS': {
            'driver': 'ODBC Driver 11 for SQL Server',  # Si es Windows, usar "SQL Server"
            'unicode_results': True
        },
    }
}
