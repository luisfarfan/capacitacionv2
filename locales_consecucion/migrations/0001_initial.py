# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-04-10 02:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('CCDD', models.CharField(max_length=2)),
                ('CCPP', models.CharField(max_length=2, primary_key=True, serialize=False)),
                ('CAPACITACION_CURSO1', models.IntegerField(blank=True, null=True)),
                ('CAPACITACION_CURSO2', models.IntegerField(blank=True, null=True)),
                ('CAPACITACION_CURSO3', models.IntegerField(blank=True, null=True)),
                ('CAPACITACION_CURSO4', models.IntegerField(blank=True, null=True)),
        ...
        migrations.AddField(
            model_name='personal',
            name='profesion',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='locales_consecucion.Profesion'),
        ),
        migrations.AddField(
            model_name='personal',
            name='tipo_inst',
